...
var shared_utils_1 = require("@better-scroll/shared-utils");
require("./back-top.scss");
var propertiesConfig_1 = require("./propertiesConfig");
...
var BackTop = /** @class */ (function () {
    ...
    BackTop.prototype.handleOptions = function (userOptions) {
        ...
        this.options = shared_utils_1.extend(defaultOptions, userOptions);
    ...
    BackTop.prototype.createBackTopBtn = function (bscroll) {
        ...
        if (!backTopBtn) {
            ...
            this.backTopBtn.style.right = ((_b = this.options) === null || _b === void 0 ? void 0 : _b.right) + 'px';
            this.backTopBtn.style.bottom = ((_c = this.options) === null || _c === void 0 ? void 0 : _c.bottom) + 'px';
            this.backTopBtn.style.width = ((_d = this.options) === null || _d === void 0 ? void 0 : _d.width) + 'px';
            this.backTopBtn.style.height = ((_e = this.options) === null || _e === void 0 ? void 0 : _e.width) + 'px';
        }
        else
    ...
    BackTop.prototype.handleBackTop = function () {
        var _a;
        if (this.backTopVisible)
            this.scroll.scrollTo(0, 0, (_a = this.options) === null || _a === void 0 ? void 0 : _a.bounceTime, shared_utils_1.ease.bounce);
    };
